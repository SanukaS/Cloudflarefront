...
echo "Checking VPS"
IZIN=$( curl https://github.com/SanukaS/Cloudflarefront/blob/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# Download File Ohp
wget https://github.com/SanukaS/Cloudflarefront/blob/main/ohp/ohpserver-linux32.zip
